...
| 3  | Michael Brown  | AI Engineer | Expert in machine learning and NLP systems. | <h3>Expertise</h3><p>Michael specializes in <strong>machine learning</strong> and <strong>NLP pipelines</strong>.</p><ul><li>Text embeddings</li><li>Semantic search</li><li>Summarization</li></ul><p><a href="#">Read technical articles</a></p> | Expert | michael@example.com     |
